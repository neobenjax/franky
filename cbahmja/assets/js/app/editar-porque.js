$(document).ready(function(){
  ...
  $(document).on('click','#editarContenido',function(event){
    ...
    $.fancybox({type:'iframe',href:getURL()+'previewStatic.php?t='+Base64.encode($("#titulo").val())+'&i=1',width: "100%",modal:true,top:0,fitToView: true});
  });


    $("#editar-porque").validate({
